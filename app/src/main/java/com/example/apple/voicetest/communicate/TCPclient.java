...
import com.example.apple.voicetest.ActivityRecog;
...
public class TCPclient implements Runnable{
    ...
    private String  serverIP = "192.168.12.1";
    ...
    public void run() {
        ...
        while (isRun){
            try {
                ...
                ActivityRecog.context.sendBroadcast(intent);
